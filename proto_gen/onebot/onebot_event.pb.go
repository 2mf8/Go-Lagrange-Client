...
type PrivateMessageEvent struct {
	...
	Extra         map[string]string           `protobuf:"bytes,255,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_onebot_event_proto_rawDesc = string([]byte{
...
var (
	...
	file_onebot_event_proto_rawDescData []byte
)

func file_onebot_event_proto_rawDescGZIP() []byte {
	file_onebot_event_proto_rawDescOnce.Do(func() {
		file_onebot_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_onebot_event_proto_rawDesc), len(file_onebot_event_proto_rawDesc)))
	})
	return file_onebot_event_proto_rawDescData
}

var file_onebot_event_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_onebot_event_proto_goTypes = []any{
...
func file_onebot_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_onebot_event_proto_rawDesc), len(file_onebot_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   28,
			NumExtensions: 0,
			NumServices:   0,
